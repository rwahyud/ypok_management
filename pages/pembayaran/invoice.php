        ...
        <div class="invoice-body">
            <div class="invoice-info">
                <div class="info-section">
                    ...
                    <p><span class="highlight">Tanggal:</span> <?php echo date('d F Y', strtotime($pembayaran['tanggal_bayar'])); ?></p>
                    <p><span class="highlight">Kategori:</span> <?php echo htmlspecialchars($pembayaran['jenis_pembayaran']); ?></p>
                    ...
                    <span class="detail-value">
                        <span class="status-badge status-<?php
                            echo $pembayaran['status'] == 'lunas' ? 'lunas' :
                                ($pembayaran['status'] == 'pending' ? 'sebagian' : 'belum');
                        ?>">
