    ...
    <header>
        <div class="container">
            <div class="logo">
                ...
                <div>
                    <h1>YPOK</h1>
                    <p>Pendidikan Olahraga Karate</p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="counts-grid">
                ...
                <div class="count-item">
                    ...
                    <div class="count-label">Siswa Aktif</div>
                </div>
                <div class="count-item">
                    <div class="count-number"><?php echo number_format($total_lokasi); ?></div>
                    <div class="count-label">Lokasi Dojo</div>
                </div>
                <div class="count-item">
                    <div class="count-number"><?php echo number_format($total_kegiatan); ?></div>
                    <div class="count-label">Kegiatan & Event</div>
                </div>
            </div>
        </div>
    </section>
