<div class="sidebar">
    ...
    <ul class="sidebar-menu">
        ...
        <li>
            <a href="pendaftaran.php" <?php echo basename($_SERVER['PHP_SELF']) == 'pendaftaran.php' ? 'class="active"' : ''; ?>>
                <span class="icon">📝</span>
        ...
        <li>
            <a href="toko.php" <?php echo basename($_SERVER['PHP_SELF']) == 'toko.php' ? 'class="active"' : ''; ?>>
                <span class="icon">🛒</span>
                <span>Toko</span>
            </a>
        </li>
