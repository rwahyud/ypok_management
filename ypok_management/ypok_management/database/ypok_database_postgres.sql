...
CREATE TABLE master_sabuk_hitam (
  ...
  nomor_ijazah_tingkatan varchar(255),
  tanggal_ujian varchar(50),
  asal_provinsi varchar(100),
  alamat text,
  jenis_dan varchar(50),
  ket varchar(100),
  foto varchar(255),
  PRIMARY KEY (id)
);
...
-- Kolom tanggal_ujian sudah ada, hanya tambahkan jenis_keanggotaan jika belum ada
ALTER TABLE master_sabuk_hitam 
ADD COLUMN IF NOT EXISTS jenis_keanggotaan VARCHAR(50) DEFAULT 'Reguler';
...
ALTER TABLE master_sabuk_hitam 
ADD COLUMN IF NOT EXISTS tanggal_ujian DATE NULL,
ADD COLUMN IF NOT EXISTS jenis_keanggotaan VARCHAR(50) DEFAULT 'Reguler';
...
-- Tambahkan field baru yang diperlukan
ALTER TABLE kohai 
ADD COLUMN IF NOT EXISTS no_registrasi_ijazah VARCHAR(255) NULL,
ADD COLUMN IF NOT EXISTS tanggal_ujian DATE NULL,
ADD COLUMN IF NOT EXISTS asal_sekolah VARCHAR(255) NULL,
ADD COLUMN IF NOT EXISTS asal_provinsi VARCHAR(255) NULL,
...
-- Tanggal: 2026-02-12
-- ========================================
-- Tambah kolom total_tagihan, nominal_dibayar, sisa
ALTER TABLE pembayaran
ADD COLUMN IF NOT EXISTS total_tagihan DECIMAL(15,2) DEFAULT NULL;
ALTER TABLE pembayaran
ADD COLUMN IF NOT EXISTS nominal_dibayar DECIMAL(15,2) DEFAULT NULL;
